...
export const Dashboard = () => {
  ...
  const handleProformaSubmit = () => {
    navigate("/recruiter/proforma");  
  }

  const handleProformas = () => {
    navigate("/recruiter/proformas");
  }
    ...
    <Box sx={{ display: "flex", backgroundColor:"#f3f6f9" }}>
      ...
      >
        ...
        <List>
          ...
          <ListItem key="Proforma Submit" disablePadding onClick={handleProformaSubmit} sx={styleStudentButton}>
            <ListItemButton>
              <ListItemIcon>
                <MailIcon />
              </ListItemIcon>
              <ListItemText primary="Proforma Submit" />
            </ListItemButton>
          </ListItem>
          <ListItem
            key="Proformas"
            disablePadding
            onClick={handleProformas}
      ...
      <Main open={open} sx={{backgroundColor:"#f3f6f9",height:"100vh"}}>
        <DrawerHeader />
        <Outlet />
      </Main>
    </Box>
